...
MODEL_LOAD_GPTQ = is_true(os.getenv("MODEL_LOAD_GPTQ", ""))
MODEL_GPTQ_BITS = int(os.getenv("MODEL_GPTQ_BITS", "4"))
MODEL_GPTQ_GROUP_SIZE = int(os.getenv("MODEL_GPTQ_GROUP_SIZE", "128"))
MODEL_GPTQ_DESC_ACT = is_true(os.getenv("MODEL_GPTQ_DESC_ACT", ""))
